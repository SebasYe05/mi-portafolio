const ParteIzquierda = ({ manejarPower, manejarNavegacion, iniciarHold, detenerHold }) => {
  const hold = iniciarHold || manejarNavegacion;
  const release = detenerHold || (() => {});
  ...
  return (
    <div className="flex flex-col items-center justify-between h-full py-4 w-24">
      <div className="relative w-24 h-24 flex items-center justify-center select-none">
        ...
        {/* Vertical — solo mousedown/touch (sin onClick para evitar doble disparo) */}
